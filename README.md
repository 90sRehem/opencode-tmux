...
```text
Install the opentmux plugin by following: https://raw.githubusercontent.com/90sRehem/opentmux/main/README.md
```
...
## 🙏 Acknowledgements
This project extracts and improves upon the tmux session management from [oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim) by alvinunreal, and [opentmux](https://github.com/AnganSamadder/opentmux) by Angan Samadder (MIT License).
